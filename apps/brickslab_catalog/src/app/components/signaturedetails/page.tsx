...
const props: PropDef[] = [
  { name: "details", type: "DetailItem[]", required: true, description: "Liste des cartes (image, title, description)." },
  { name: "title", type: "string", default: '"Détails Signature"', description: "Titre de section." },
  { name: "subtitle", type: "string", description: "Sous-titre de section." },
  { name: "columns", type: "1 | 2 | 3 | 4", default: "4", description: "Nombre de colonnes dans la grille." },
  { name: "cardRadius", type: "string", default: '"4px"', description: "Border radius des cartes (CSS)." },
  { name: "sectionPadding", type: "string", default: '"8rem 0"', description: "Padding de la section (CSS)." },
  { name: "overlayColor", type: "string", default: '"rgba(20,20,20,0.9)"', description: "Couleur du dégradé overlay." },
  { name: "imageAspectRatio", type: "string", default: '"3/4"', description: "Aspect ratio des images (ex: \"1/1\", \"16/9\")." },
...
const usageCode = `import { SignatureDetails } from "@brickslab./ui-web";
  ...
  return (
    <div>
      <ComponentHeader
        ...
        section="Animation"
        description="Section en grille avec images, zoom au survol et overlay descriptif animé. Idéal pour présenter des détails produit, une collection, ou des éléments de marque."
      />

      <SectionTitle>Aperçu</SectionTitle>

      <SubLabel>Grille 4 colonnes (overlay au survol)</SubLabel>
      <Preview style={{ padding: 0, width: "100%" }}>
        <SignatureDetails details={sampleDetails} columns={4} cardRadius="10px" sectionPadding="56px 0" />
      </Preview>

      <SubLabel>Grille 2 colonnes (plus lisible sur viewport étroit)</SubLabel>
      <Preview style={{ padding: 0, width: "100%" }}>
        <SignatureDetails
